...
""" Бублики, короткая игра, где нужно угадать три числа по подсказкам """
NUM_GIGITS = 1
MAX_GUESSES = 5
...
def main():
    print(
        """Бублики, дедуктивная логическая игра. Я имею в виду {}-значное число без повторяющихся цифр.
        Попробуйте угадать, что это такое. Вот несколько подсказок:
        Когда я говорю: Это значит: Пико-Одна цифра правильная, но в неправильном положении.
        Ферми-Одна цифра правильная и находится в правильном положении.
        Бублики-Ни одна цифра не верна.Например, если секретное число было 248, а вы угадали 843,  Ключом к разгадке будет Ферми Пико.""".format(
            NUM_GIGITS
        )
    )
